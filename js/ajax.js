//OCULTAR IMAGEN DE GUARDADO
function OcultarSeg() {
	setTimeout(function() {
		$("#div_informacion").removeAttr("style").fadeOut();
	}, 3500);
}

//FUNCION PARA QUE DE LA SOMBRA DE COLOR AMARILLO
...
//FUNCION DE LOS DATE PICKER DEL FORMULARIO DE CREACION DE PROYECTOS
$(function() {
